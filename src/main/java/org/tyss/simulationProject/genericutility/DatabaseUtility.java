...
public class DatabaseUtility {
	 ...
	 * @throws Throwable
	 */
	public int execyteUpdate(String query, Connection connection) throws Throwable {
	...
	public boolean verifyColumnContainsData(Connection connection, String tableName, String columnName,
		...
		if (flag) {
			UtilityObjectClass.getExtentTest().info(expectedData + "==>Data is verified in the database table");
			return flag;
		} else {
			UtilityObjectClass.getExtentTest().info(expectedData + "==>Data is not verified in the database");
			return flag;
		}
	}
}
